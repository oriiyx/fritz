...
func (e *EntityBuilder) genAdapterCode(d *definitions.EntityDefinition) string {
	var code strings.Builder
	...
	code.WriteString("// RegisterAdapter registers this adapter with the given queries\n")
	code.WriteString(fmt.Sprintf("func RegisterAdapter(queries *db.Queries) {\n"))
	code.WriteString(fmt.Sprintf("\tRegister(\"%s\", New%sAdapter(queries))\n", d.ID, entityName))
	code.WriteString("}\n")
...
func (e *EntityBuilder) genAdapterCreate(d *definitions.EntityDefinition) string {
	var code strings.Builder
	entityName := d.Name
...
func (e *EntityBuilder) genAdapterRead(d *definitions.EntityDefinition) string {
	var code strings.Builder
	entityName := d.Name
...
func (e *EntityBuilder) genAdapterUpdate(d *definitions.EntityDefinition) string {
	var code strings.Builder
	entityName := d.Name
...
func (e *EntityBuilder) genAdapterDelete(d *definitions.EntityDefinition) string {
	var code strings.Builder
	entityName := d.Name
...
func (e *EntityBuilder) genFieldConversion(comp definitions.DataComponent, dataVar string) string {
	...
	case "string":
		...
		return fmt.Sprintf("getString(%s, \"%s\")", dataVar, fieldName)
